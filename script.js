        ...
        card.innerHTML = `
            ...
            <div class="card-container--info">
                ...
                <div class="card-container--price">
                    ...
                    <img class="trash" src="imagens/trash.png" alt="Ícone do Lixo" onclick="deleteProduct(${product.id})">
                    <img class="edit" src="imagens/pen.png" alt="Ícone de Edição" onclick="updateProduct(${product.id})">
                </div>
            </div>
        `;
